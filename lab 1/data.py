...
class VideoDataset(Dataset):
    ...
    def __init__(self, files, labels, num_frames, transform=None, test=False):
        ...
        self.test = test
        self.frame_skip = 10
        self.face_cascade = cv2.CascadeClassifier('C:/Users/lu936/py/lab 1/haarcascade_frontalface_default.xml')
...
class ImageDataset(Dataset):
    ...
    def get_b(self, img):
        ...
        predictor = dlib.shape_predictor("C:/Users/lu936/py/lab 1/shape_predictor_68_face_landmarks.dat")
